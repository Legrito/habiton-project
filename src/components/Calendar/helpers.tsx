...
export const getMonthDays = (month: number): Moment[] => {
...
export const getNormalizedMonthDaysList = (currentDate: Moment): (Moment | null)[] => {
  const monthDays: (Moment | null)[] = [...getMonthDays(2)];
